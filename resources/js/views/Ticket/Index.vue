    ...
    <div class="data-grid">
      <div class="data-grid__header">
        ...
        <div class="data-grid__actions">
          <input type="text" class="form__control data-grid__search-input" placeholder="Search ..." v-model="searchQuery" @input="onSearchQueryChange">    
        ...
        <table class="table table-striped data-grid__table">
          ...
          <tbody class="data-grid__table-body">
            <tr v-for="(ticket, index) in tickets" :key="ticket.id" class="data-grid__table-row">
              ...
              <td class="data-grid__table-cell">{{ ticket.subject }}</td>
      ...
      <template #body>
        <form @submit.prevent="createTicket">
          <div class="form__group">
            ...
            <input type="text" class="form__control" id="subject" placeholder="Enter subject" required v-model="newTicket.subject">
          </div>
          <div class="form__group">
            <label for="body" class="form__label">Body</label>
            <textarea class="form__control" id="body" placeholder="Enter body" required v-model="newTicket.body"></textarea>
          </div>
